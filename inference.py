...
def main(args):
    ...
    wide_source, arc_source, mask_source = process_img(args.source, swap_mode=args.swap_mode)
    wide_target, arc_target, mask_target, full_frames, M = process_img(args.target, target=True, swap_mode=args.swap_mode)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--swap_mode', default='head', choices=['head', 'face', 'both'],help='Swap mode: head, face, or both')

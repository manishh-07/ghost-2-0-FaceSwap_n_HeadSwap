...
class AlignerModule(pl.LightningModule):
    def __init__(self, cfg):
        ...
        self.swap_mode = getattr(cfg, 'swap_mode', 'head')
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        X_dict = make_X_dict(
            ...
            X_mask=train_batch['face_wide_mask'],
    ...
    def validation_step(self, val_batch, batch_idx, dataloader_idx):
        ...
        X_dict = make_X_dict(
            val_batch['face_arc'],
            val_batch['face_wide'],
            val_batch['face_wide_mask'],
            val_batch.get('face_emoca', {}),
            val_batch.get('keypoints', {}),
            val_batch.get('segmentation', {}),
            swap_mode=self.swap_mode
        )        
        with torch.no_grad():
